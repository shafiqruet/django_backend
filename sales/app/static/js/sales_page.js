...
function App() {
  ...
  const saveOrder = (e) => {
    ...
    if (item.length * price * quantity === 0) setError("Please enter item name, price and quantity");
    else {
      if (itemId === null)
  ...
  return (
    <div onKeyDown={keyDownHandler}>
      <div style={{ background: "#00000060" }} className={"modal " + (showModal ? " show d-block" : " d-none")} tabIndex="-1" role="dialog">
      ...
      <div style={{ maxWidth: "1000px", margin: "auto", marginTop: "1em", marginBottom: "1em", padding: "1em" }} className="shadow">
        <div style={{ display: "flex", flexDirection: "row", marginBottom: "5px" }}>
          {pages.length > 0 && (
            <nav className="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
              <ul className="pagination">
                ...
                <li
                  className={"page-item " + (page === pages.length - 1 ? "disabled" : "")}
                  onClick={(e) => {
          ...
          <a className="btn btn-light" style={{ marginLeft: "auto" }} onClick={newOrder}>
            New Sales Order
          </a>
        </div>
